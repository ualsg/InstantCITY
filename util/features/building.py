...
class Building_features:
    ...
    def __init__(self, kernel_size_denoise = 3, kernel_size_grow = 10, simplify_threshold = 0.0001):
        self.features = []
        self.kernel_size_denoise =kernel_size_denoise
        self.kernel_size_grow = kernel_size_grow
